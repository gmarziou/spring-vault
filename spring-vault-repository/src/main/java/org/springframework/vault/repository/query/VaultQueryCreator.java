...
public class VaultQueryCreator extends
	...
	@Override
	protected VaultQuery create(Part part, Iterator<Object> iterator) {
		return null;
	}

	@Override
	protected VaultQuery and(Part part, VaultQuery vaultQuery, Iterator<Object> iterator) {
		return null;
	}

	@Override
	protected VaultQuery or(VaultQuery vaultQuery, VaultQuery s1) {
		return null;
	}
